...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Hahaha Đấm Chết Cụ Web Nó Đi => " + str((until - datetime.datetime.now()).total_seconds()) + " sec left ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.WHITE+" Đấm Chết Cụ Nó Thành Công !                                   \n")
            return
...
def title():
    ...
    stdout.write("                                                                                          \n")
    stdout.write("                                 "+Fore.LIGHTMAGENTA_EX+"  Nguyễn Xuân Trường                  \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX    +"    Coder Vip Pro                           \n")
    stdout.write("                                 "+Fore.RED            +" Tool Tổng Hợp ddos crack                        \n")
    stdout.write("             "+Fore.RED            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             \x1b[38;2;255;0;0m╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m        Welcome To Màn Hình ddos Của Trường\x1b[38;2;255;0;0m         ║\n")
    stdout.write("             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m          Ấn [HELP] Để Mò Lệnh ddos          \x1b[38;2;255;0;0m       ║\n")
    stdout.write("             \x1b[38;2;255;0;0m║ \x1b[38;2;0;255;189m         Contact Zalo 0564731627            \x1b[38;2;255;0;0m        ║\n")
    stdout.write("             \x1b[38;2;255;0;0m╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
...
def command():
    ...
    if command == "cls":
        ...
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"Developer          "+Fore.RED+": \x1b[38;2;0;255;189mNguyễn Xuân Trường\n")
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"UI Design          "+Fore.RED+": \x1b[38;2;0;255;189mKAREMA DEVELOPER\n")
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"Methods And Tools  "+Fore.RED+": \x1b[38;2;0;255;189mProCodeSilext\n")
    elif command == "cfb":
